      ...
      <Container>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h2
            ...
            className="font-display font-semibold text-text mb-8 text-balance"
            style={{
          ...
          <motion.p
            ...
            className="font-body text-text-muted mb-12"
            style={{ fontSize: '1rem' }}
          >
            Reply usually within a few hours.
          </motion.p>
            ...
            {emailAddress && (
              <MagneticButton>
                <a href={`mailto:${emailAddress}`}>
                  <Button variant="ghost">Send an email</Button>
                </a>
              </MagneticButton>
            )}
          </motion.div>
